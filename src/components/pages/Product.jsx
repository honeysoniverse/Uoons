...
const Product = ({ setProductId , setCategoryId, showLabel, }) => {
  ...
  const allProductData = async () => {
    const response = await axios.get(
      `${getAllProduct}/${sellerId}?pageNo=${currentPage}&pageSize=5`,
      {
        headers: {
            ...
            <Table variant="striped" colorScheme="gray">
              ...
              >
                {productData?.reverse().map((currElem, index, productId) => {
                  console.log(currElem,"<<<<<<<<product page ka data")
                  return (
                    <>
                      <Tr key={index}>
                        <Td>
                        ...
                        <Td>
                          <Icon
                            as={FaEdit}
                            onClick={() => editProduct(currElem.productId)}
                            fill="blue"
                            ml="10px"
                            cursor="pointer"
                            height="50px"
                        ...
                        <Td>
                          <Icon
                            as={FaTrashAlt}
                            onClick={() => deleteProduct(currElem.productId)}
                            fill="red"
                            ml="10px"
                            cursor="pointer"
                            height="50px"
