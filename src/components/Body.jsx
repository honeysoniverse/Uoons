...
import { Text, VStack, SimpleGrid, Box, Flex, Icon } from '@chakra-ui/react';
import axios from 'axios';
import { colors } from '../resources/colors';
import { FaRupeeSign, FaChartLine, FaTimes, FaPause,FaCalendarAlt } from 'react-icons/fa';
    ...
    >
      <VStack bg={colors.backgroundGray} alignItems="flex-start" ml="20px">
        ...
        <Text
          ...
          fontSize="sm"
        >
          Let's get your business started in view steps
        </Text>
      </VStack>
      <Box>
